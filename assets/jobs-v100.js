(function(){
 ...
 function syncTop(){var h=q('[data-site-header],.wp-theme-site-header');if(h)document.documentElement.style.setProperty('--jobs-v100-nav-top',Math.max(0,Math.round(h.getBoundingClientRect().bottom))+'px')}
