...
function navTop(){var h=q('[data-site-header],.wp-theme-site-header');var top=h?Math.max(0,Math.round(h.getBoundingClientRect().bottom)):76;D.documentElement.style.setProperty('--jobs-v101-nav-top',top+'px')}
